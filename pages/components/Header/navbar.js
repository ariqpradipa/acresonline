...
function NavLink({ to, isOpen, children }) {
    return (
        <a
            href={to}
            className={`mx-6 text-xl font-montserrat ${isOpen
...
function MobileNav({ isOpen, setIsOpen }) {
    return (
        <div
            className={`absolute top-0 left-0 h-screen w-screen bg-white transform ${isOpen ? "-translate-x-0" : "-translate-x-full"
